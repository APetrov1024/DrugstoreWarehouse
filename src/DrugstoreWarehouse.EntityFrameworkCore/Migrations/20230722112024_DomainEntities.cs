        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelNumber = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Batches_Quantity_Range", "\"Quantity\" >= 0 AND \"Quantity\" <= 2147483647");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_DrugstoreId",
                table: "Warehouses",
                column: "DrugstoreId");
        }
