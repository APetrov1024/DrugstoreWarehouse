...
{
    [DbContext(typeof(DrugstoreWarehouseDbContext))]
    [Migration("20230729125822_DisableCascadeDelete")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrugstoreWarehouse.Batches.Batch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Batches", null, t =>
                        {
                            t.HasCheckConstraint("CK_Batches_Quantity_Range", "\"Quantity\" >= 0 AND \"Quantity\" <= 2147483647");
                        });
                });

            modelBuilder.Entity("DrugstoreWarehouse.Drugstores.Drugstore", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Drugstores", (string)null);
                });

            modelBuilder.Entity("DrugstoreWarehouse.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DrugstoreWarehouse.Warehouses.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DrugstoreWarehouse.Batches.Batch", b =>
                {
                    b.HasOne("DrugstoreWarehouse.Products.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DrugstoreWarehouse.Warehouses.Warehouse", "Warehouse")
                        .WithMany("Batches")
            ...
            modelBuilder.Entity("DrugstoreWarehouse.Warehouses.Warehouse", b =>
                {
                    b.HasOne("DrugstoreWarehouse.Drugstores.Drugstore", "Drugstore")
                        .WithMany("Warehouses")
